...
set :rvm_ruby_string, '1.9.2-p0@rails3'
set :rvm_type, :system
...
#    Deployment Settings
#############################################################
set :application, "gladneyfamilyreunion.org"
...
namespace :media do
  task :setup, :roles => :app, :except => { :no_release => true }  do
    run "mkdir -p #{shared_path}/media/audio"
...
after "deploy:finalize_update", "media:symlink"